...
<!-- Ganti class body atau bungkus konten utama dengan div ini -->
<div class="min-h-screen w-full flex flex-col justify-center items-center">
    
    <!-- Konten di dalam grid -->
    <div class="text-center p-8 bg-[#252626]/80 backdrop-blur-md rounded-xl border border-gray-800 shadow-2xl">
        <h1 class="text-4xl font-bold text-white tracking-wide">Home Page Admin Jurusan SMK</h1>
<a href="{{ route('filament.admin.auth.login') }}" class="inline-block py-2 px-4 bg-amber-500 hover:bg-amber-600 text-white font-medium rounded-md transition">
    Ke Login Admin
</a>
    </div>
...
<!-- Taruh CSS di bagian bawah file Blade -->
<style>
